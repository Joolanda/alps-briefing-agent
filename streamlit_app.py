...
from alps_briefing.services.avalanche_slf import fetch_slf_bulletin_parsed
...
if st.button("Generate briefing"):
    ...
    st.markdown("### Avalanche bulletin (SLF, parsed CAAML)")
    st.json(fetch_slf_bulletin_parsed())
